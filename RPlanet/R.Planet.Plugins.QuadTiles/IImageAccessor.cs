...
namespace R.Earth.QuadTile
{
    public interface IImageAccessor
    {
        ...
        GeoSpatialDownloadRequest RequestTexture(DrawArgs drawArgs, /*BoundingBox boundingBox,*/ GeographicBoundingBox geoBox, int level);

        string GetImagePath(GeographicBoundingBox geoBox, int level);

        Microsoft.DirectX.Direct3D.Texture GetTexture(DrawArgs drawArgs, /*BoundingBox boundingBox,*/ GeographicBoundingBox geoBox, int level);
