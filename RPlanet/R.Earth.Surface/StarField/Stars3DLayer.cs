...
namespace R.Earth.StarField
{

    /// <summary>
    /// Sky dome
    /// </summary>
    public class Stars3DLayer : GeoLayer
    {
        ...
        /// Constructor
        /// </summary>
        public Stars3DLayer(string LayerName, string pluginPath, UI.WorldViewer worldWindow)
            : base(LayerName)
        {
        ...
        public override void OnRender(DrawArgs drawArgs)
        {
            ...
            if (drawArgs.WorldCamera.Altitude < 10e3) return;
        ...
        private void LoadStars()
        {
            ...
            while ((line = tr.ReadLine()) != null)
            {
                ...
                if (isData == 1) // Star data here
                {
                    ...
                    v = SMath.SphericalToCartesian(latitude, longitude, sphereRadius);
        ...
        public class propertiesDialog : System.Windows.Forms.Form
        {
            ...
            private void btnOK_Click(object sender, System.EventArgs e)
            {
                if (cboTexture.SelectedItem != null)
                {
                    ...
                    layer.OnInitialize(layer.drawArgs);
                    layer.SaveSettings();
                }
                // Close this form
                this.Close();
