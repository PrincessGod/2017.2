...
namespace R.Earth.OverLayer
{
    ...
    /// </summary>
    public abstract class WidgetTreeNode : WidgetCollection, IWidget, IInteractive
    {
        ...
        protected GeoLayer m_renderableObject;
        ...
        public GeoLayer RenderableObject
        {
        ...
        public bool Enabled
        {
            get
            {
                if (m_renderableObject != null)
                    m_enabled = m_renderableObject.IsVisible;
            ...
            set
            {
                m_enabled = value;
                if (m_renderableObject != null)
                    m_renderableObject.IsVisible = value;
        ...
        public WidgetTreeNode(string name)
            : this()
        {
            m_name = name;
        }
        ...
        {
            if (this.m_parentWidget != null && m_parentWidget is WidgetTreeNode)
            {
                WidgetTreeNode parentNode = (WidgetTreeNode)m_parentWidget;
