...
{
    public abstract class ControlMenuButton : IMenu
    {
        ...
        public ControlMenuButton(string iconTexturePath)
        {
        ...
        {
            float width = selected ? ControlMenuButton.SelectedSize : width = ControlMenuButton.NormalSize;
