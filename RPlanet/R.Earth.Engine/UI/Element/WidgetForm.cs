...
namespace R.Earth.OverLayer.Element
{
    ...
    /// fine instead.
    /// </summary>
    public class WidgetForm : WidgetCollection, IWidget, IInteractive
    {
        /// <summary>
        ...
        public AnchorWidgetStyles Anchor = AnchorWidgetStyles.None;
        ...
        public System.Drawing.Point Location
        {
            get
            {
                ...
                if (((Anchor & AnchorWidgetStyles.Bottom) != 0) && (m_parentWidget != null))
                {
                ...
                if (((Anchor & AnchorWidgetStyles.Right) != 0) && (m_parentWidget != null))
                {
                    // if the distance has changed then reset the location.
        ...
        public void Initialize(DrawArgs drawArgs)
        {
            ...
            {
                AddFontResource(Path.Combine(EarthSetting.MediaSourcePath, "mings 1.0.ttf"));
                System.Drawing.Text.PrivateFontCollection fpc = new System.Drawing.Text.PrivateFontCollection();
                fpc.AddFontFile(Path.Combine(EarthSetting.MediaSourcePath, "mings 1.0.ttf"));
                System.Drawing.Font m_worldwinddings = new System.Drawing.Font("Arial", 12.0f);
        ...
        public void Render(DrawArgs drawArgs)
        {
            ...
            if ((HeaderEnabled && !AutoHideHeader) ||
                ...
                DrawArgs.Instance.LastMousePosition.X >= widgetLeft &&
                DrawArgs.Instance.LastMousePosition.X <= widgetRight &&
                DrawArgs.Instance.LastMousePosition.Y >= widgetTop &&
                DrawArgs.Instance.LastMousePosition.Y <= widgetBottom)) ||
                !m_renderBody)
            {
        ...
        public bool OnKeyPress(System.Windows.Forms.KeyPressEventArgs e)
        {
            for (int i = m_ChildWidgets.Count - 1; i >= 0; i--)
            {
                if (m_ChildWidgets[i] is IInteractive)
                {
                    ...
                    if (currentInteractive.OnKeyPress(e))
                        return true;
                }
            }
            return true;
        ...
        protected void UpdateLocation()
        {
            ...
            {
                height = DrawArgs.Instance.ScreenHeight;
                width = DrawArgs.Instance.ScreenWidth;
            }

            // if anchors are active recompute distances from anchor location
            if (Anchor != AnchorWidgetStyles.None)
            {
