    ...
    public class CameraBase
    {
        ...
        public virtual Angle Tilt
        {
            ...
            set
            {
                ...
                {
                    _altitude = _terrainElevation + minimumAltitude;
                    // TODO:
        ...
        public virtual double TargetAltitude
        {
            ...
            set
            {
                if (value < _terrainElevation  + minimumAltitude)
                    value = _terrainElevation  + minimumAltitude;
        ...
        public Vector3d ReferenceCenter = new Vector3d(0, 0, 0);
