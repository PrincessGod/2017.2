...
namespace R.Earth
{
    ...
    public class MatrixV
    {
        ...
        public MatrixV(int rows, int columns)
        {
            this.rows = rows;
        ...
        public MatrixV(int rows, int columns, double value)
        {
            this.rows = rows;
            this.columns = columns;
            this.data = new double[rows][];
        ...
        {
            return Equals(this, (MatrixV)obj);
        }
        ...
        /// <summary>Unary minus.</summary>
        public static MatrixV operator -(MatrixV value)
        {
            if (value == null)
            {
                throw new ArgumentNullException("value");
        ...
        public static bool operator ==(MatrixV left, MatrixV right)
        {
        ...
        public static MatrixV Add(MatrixV left, MatrixV right)
        {
            if (left == null)
            {
        ...
        /// <summary>Matrix addition.</summary>
        public static MatrixV operator +(MatrixV left, MatrixV right)
        {
            if (left == null)
            {
                throw new ArgumentNullException("left");
        ...
        /// <summary>Matrix-scalar multiplication.</summary>
        public static MatrixV operator *(MatrixV left, double right)
        {
            if (left == null)
            {
                throw new ArgumentNullException("left");
